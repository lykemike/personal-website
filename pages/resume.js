          ...
          <div className="p-2 border-[1px] rounded-sm border-neutral-500 shadow-md">
            <div className="md:grid md:grid-cols-4 md:gap-4">
              ...
              <div className="col-span-3 mt-2 md:mt-0">
                ...
                <div className="flex items-center space-x-2 text-base">
                  <HiPhone size="20px" />
                  <span className="text-neutral-700">+62 812 4596 5369</span>
                </div>
                <div className="flex items-center space-x-2 text-base">
                  <BsLinkedin size="20px" />
                  <Link href="https://www.linkedin.com/in/michael-kevin-montolalu-b507881b7/">
                    <a>
              ...
              <div className="col-span-3">
                ...
                <div className="mt-2">
                  ...
                  <p>
                    ...
                    <br />• Worked in scrum environment
                    <br />• Developed web application using Next.js, JavaScript, PostgreSQL, Prisma, Material UI,
                    Tailwind CSS, Ant Design and Charting Libraries
                  </p>
                </div>
              </div>
